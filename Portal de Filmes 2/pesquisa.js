	...
	for (i = 0; i < lista.results.length; i++) {
		...
		switch (registro.media_type) {
			case "movie":
				...
				texto += `
					<a href="detalhes.html?id=${registro.id}" target="_blank" class="list-group-item list-group-item-action flex-column align-items-start" style="background: #555; color:black;">
						<div class="row">
							<div class="col-4">
			...
			case "tv":
				...
				texto += `
					<a href="${BASE_SITE_URL}tv/${registro.id}" target="_blank" class="list-group-item list-group-item-action flex-column align-items-start" style="background: #555; color:black;">
						<div class="row">
							<div class="col-4">
								<img src="${registro.poster_path ? BASE_IMG_URL + registro.poster_path : DEFAULT_IMAGE}">
							</div>
			...
			case "person":
				...
				texto += `
					<a href="${BASE_SITE_URL}person/${registro.id}" target="_blank" class="list-group-item list-group-item-action flex-column align-items-start" style="background: #555; color:black;">
						<div class="row">
							<div class="col-4">
